...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Play puzzle games, earn draw entries, and win cash prizes weekly on WinamGames." },
      { name: "author", content: "WinamGames" },
      { property: "og:title", content: "WinamGames — Play. Win. Repeat." },
      { property: "og:description", content: "Play puzzle games, earn draw entries, and win cash prizes weekly on WinamGames." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "theme-color", content: "#1a1a2e" },
      { name: "twitter:title", content: "WinamGames — Play. Win. Repeat." },
      { name: "twitter:description", content: "Play puzzle games, earn draw entries, and win cash prizes weekly on WinamGames." },
